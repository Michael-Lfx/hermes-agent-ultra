...
impl SkillGuard {
    ...
    pub fn scan_security_with_policy(&self, skill: &Skill, source: &str) -> Result<(), SkillError> {
        ...
        match mode {
            ...
            SkillGuardMode::Strict => {
                let findings = crate::skills_guard::scan_content("SKILL.md", &skill.content);
                let trust_level = crate::skills_guard::resolve_trust_level(source);
                let verdict = crate::skills_guard::determine_verdict(&findings);
                let result = crate::skills_guard::ScanResult {
                ...
                match decision {
                    ...
                    | crate::skills_guard::InstallDecision::Blocked => {
    ...
    pub fn enforce_install_bundle(
        ...
        let scan = crate::skills_guard::scan_bundle(install_name, source, files);
