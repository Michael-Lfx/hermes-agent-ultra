//! Repo-review tool profile narrowing and discovery budget policy.
//!
//! Extracted from `agent_loop.rs`. Contains logic for filtering tool calls
//! during repo-review sessions to keep the agent focused on high-signal actions.
...
use crate::objective_guard::detect_repo_review_intent;

// ---------------------------------------------------------------------------
// RepoReviewBudgetState
// ---------------------------------------------------------------------------
