...
fn push_declared_signal(
    ...
    out.push(InterestSignal {
        ...
        weight_delta,
        tags: vec!["interest".to_string(), "declared".to_string()],
    });
}

fn is_declared_noise(canonical: &str) -> bool {
...
pub fn split_interest_fragments(raw: &str) -> Vec<String> {
