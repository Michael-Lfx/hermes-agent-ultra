...
impl FundamentalsSnapshot {
    fn field_present(&self, field: &str) -> bool {
        match field {
            ...
            "roe_latest" => self.roe_latest.is_some(),
            "debt_ratio" => self.debt_ratio.is_some(),
            "pe_quantile_5y" => self.pe_quantile_5y.is_some(),
            "industry" => self.industry.as_ref().is_some_and(|s| !s.is_empty()),
